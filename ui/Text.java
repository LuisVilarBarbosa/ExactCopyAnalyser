...
public class Text {
    ...
    public Text() {
        ...
        if (language.equalsIgnoreCase("pt")) {
            ...
            progressMsg = specialSequence + " / " + specialSequence + " = " + specialSequence + "% Encontrado(s): " + specialSequence + " Tempo restante: " + specialSequence;
            ...
            progressMsg = specialSequence + " / " + specialSequence + " = " + specialSequence + "% Found: " + specialSequence + " Remaining time: " + specialSequence;
            remainingTimeMsg = specialSequence + "h" + specialSequence + "m" + specialSequence + "s";
